...
class EmpresaPersona(models.Model):
    ...
    emppe_fono2 = models.CharField(max_length=15, blank=True, null=True, verbose_name="Teléfono secundario")
    emppe_mail1 = models.EmailField(max_length=100, verbose_name="Correo principal")
    emppe_mail2 = models.EmailField(max_length=100, blank=True, null=True, verbose_name="Correo secundario")
...
def borrar_direccion_asociada(sender, instance: EmpresaPersona, **kwargs):
    """
    Elimina la dirección asociada si no es usada por otra EmpresaPersona.
    """
