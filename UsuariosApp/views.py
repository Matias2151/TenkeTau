...
def solicitar_recuperacion(request):
    ...
    - Se envía un código de un solo uso al correo asociado.
    """
    ...
    if request.method == "POST" and form.is_valid():
        ...
        PasswordResetCode.objects.create(user=usuario, code=codigo)

        asunto = "Recuperación de contraseña TEKNETAU"
        mensaje = (
            "Has solicitado recuperar tu contraseña en TEKNETAU.\n\n"
            f"Código de verificación: {codigo}\n"
            "Este código caduca en 15 minutos y solo puede usarse una vez.\n\n"
        ...
        messages.success(
            request,
            "Se ha enviado un código a tu correo. Ingresa el código para restablecer tu contraseña."
        )
        return redirect("usuariosapp:verificar_codigo")
